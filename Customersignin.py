...
import cx_Oracle
from CUSTdashboard import AfterLogin
from PyQt5 import QtCore, QtGui, QtWidgets
from customerforgetpassword import Forgot
...
"")
        ...
        self.label_3.setStyleSheet("background-image: url(../downloads/How to Apply for Passport in Pakistan_ Step-by-Step Guide.jpg);\n"
"")
        ...
        self.label_5.setStyleSheet("font-family:\'Montserrat\';color:beige ;\n"
                                   "font-size:15px;\n")
...
"color: ;color:beige;;")
        ...
        self.label_6.setStyleSheet("font-family:\'Montserrat\';color:beige ;\n"
"font-size:25px;\n"
"")
...
"}")
            ...
            self.lineEdit_3.setStyleSheet("QLineEdit:Focus\n"
                                          "{\n"
                                          "border-bottom:2px solid red;beige\n"
                                          "}\n""QLineEdit\n"
"{\n"
"border-bottom: 1px solid black; \n"
"}")
            ...
            self.lineEdit_3.setFocus()
             ...
             try:
                 ...
                 with cx_Oracle.connect('system/Oracle_1') as co:
                    cur = co.cursor()
                    y = []
                    sql = """Select * FROM PERSON_T10 WHERE User_name=(:1) AND  password=(:5)"""
