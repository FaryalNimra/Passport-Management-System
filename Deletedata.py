...
"")
        ...
        self.Fdbck_Name_2.setStyleSheet("border:none;color:beige\n"
"border-bottom:1px solid black;\n"
"")
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.F_Department.setPlaceholderText(_translate("Dialog", "First Name"))
        self.F_Department_2.setPlaceholderText(_translate("Dialog", "Enter  user First Name"))
        ...
        self.Fdbck_Name_2.setPlaceholderText(_translate("Dialog", "Enter user Last name "))
        self.label_3.setText(_translate("Dialog", "Deleting User Data "))
        self.label_4.setText(_translate("Dialog", "ⓔ PMS"))
        self.F_Department_3.setPlaceholderText(_translate("Dialog", "Enter  user CNIC no."))
    ...
    def deleting(self):
        try:
            ...
            if self.F_Department_3.text() == "" or self.F_Department_2.text() == ""or self.Fdbck_Name_2.text() == "":
                ...
                p_cnic_no =  self.F_Department_3.text()
                p_first_name= self.F_Department_2.text()
                p_last_name =  (self.Fdbck_Name_2.text())
                with cx_Oracle.connect('system/Oracle_1') as co:
                    cur = co.cursor()
                    cur.callproc("DELETE_PERSON_T12_BY_CNIC1", [p_cnic_no, p_first_name, p_last_name])
