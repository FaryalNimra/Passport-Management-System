...
"border-bottom:1px solid black;")
        ...
        self.SysCust.setStyleSheet("font: 10pt , color:blue; ,\"MS Shell Dlg 2\";color:beige")
        self.SysCust.setObjectName("SysCust")
        self.label_9 = QtWidgets.QLabel(self.frame)
        self.label_9.setGeometry(QtCore.QRect(540, 140, 121, 16))
        self.label_9.setStyleSheet("font: 10pt , color:blue \"MS Shell Dlg 2\";color:beige\n"
"")
...
"border-bottom:1px solid black;")
        ...
        self.SysEmp.setStyleSheet("font: 10pt \"MS Shell Dlg 2\";color:beige")
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.SysCust.setText(_translate("Dialog", "Male"))
        self.SysEmp.setText(_translate("Dialog", "Female "))
        ...
        self.label_12.setText(_translate("Dialog", "Last Name"))
        self.M_Name.setPlaceholderText(_translate("Dialog", "e.g. e.g. Arshad"))
        self.label_8.setText(_translate("Dialog", "CNIC No."))
        self.L_Name.setPlaceholderText(_translate("Dialog", "xxxxx-xxxxxxx-x"))
        ...
        self.pushButton_6.setText(_translate("Dialog", "Activate/Renew "))


        self.label.setText(_translate("Dialog", "Activation and Renewal "))
