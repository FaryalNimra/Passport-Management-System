...
"}")
        ...
        self.tableWidget.setStyleSheet("background-color:beige;\n"
"color: black ;")
        ...
        # Assuming self.tableWidget is your QTableWidget instance
        ...
        self.tableWidget.setHorizontalHeaderItem(9, city_item)

        # Add column for Gender
        gender_item = QtWidgets.QTableWidgetItem("Gender")
        gender_item.setFont(font)
        self.tableWidget.setHorizontalHeaderItem(10, gender_item)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "CNIC no."))
        ...
        item.setText(_translate("Dialog", "Nationality"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Dialog", "Contact no."))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Dialog", "Disability"))
    ...
    def inset(self):
        try:
            with cx_Oracle.connect('system/Oracle_1') as co:
                cur = co.cursor()
                quey = """SELECT * FROM  customer_data"""
