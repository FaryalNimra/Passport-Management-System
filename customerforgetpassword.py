...
"")
        ...
        self.label_3.setGeometry(QtCore.QRect(0, 50, 520, 441))
        self.label_3.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.label_3.setStyleSheet("background-image: url(E:\downloads\AdobeStock_273612541_Preview.jpeg);\n"
"")
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("E:\downloads\Anxious Person Clipart Transparent Background, Confused Anxious Person Thinking Flat Illustration, Anxious Person, Confused Person, Person Thinking PNG Image For Free Download.jpg"))
...
"}")
        ...
        self.lineEdit_4.setStyleSheet("border-bottom: 1px solid black;color:beige ")
        ...
        self.label.setStyleSheet("color: rgb(30,144,255);color:beige\n"
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_4.setPlaceholderText(_translate("Dialog", "Enter Your username"))
        self.label.setText(_translate("Dialog", "ⓔ PMS"))
    def change(self):
        p_User_name=(self.lineEdit_4.text())
        p_new_password= (self.lineEdit_2.text())
        p_new_con_Passwrd= ( self.lineEdit_3.text())
        msg = QMessageBox()
        if  p_new_con_Passwrd ==   p_new_password:
            try:
                with cx_Oracle.connect('system/Oracle_1') as co:
                    cur = co.cursor()
                    cur.callproc("UPDATE_PERSON_T10", [
                        p_User_name,
                        p_new_password,
                        p_new_con_Passwrd
                    ])
