...
"};\n")
        ...
        self.label.setGeometry(QtCore.QRect(400, 0, 441, 391))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("E:/downloads/question-mark-1872665_640.jpg"))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "CNIC_no"))
        ...
        try:
            with cx_Oracle.connect('system/Oracle_1') as co:
                cur = co.cursor()
                quey = """SELECT First_name, Last_name , CNIC_no FROM FEED_BACK"""
